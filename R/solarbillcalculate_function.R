...
solarbillcalculate <- function(interval_data,solar.prod,discount){
  ...
  ##summer peak is from 11:00-18:00
  peak[12:18,'peak.summer'] <- 1
  ##summer semi-peak is from 6:00-11:00 and 18:00-22:00
  peak[c(7:11,19:22),'semi.summer'] <- 1
